...
class SearchForm(forms.Form):
    ...
    brand = forms.CharField(label='Brand', max_length=16, required=False)
    ...
    reslution = forms.CharField(label='Resolution', max_length=12, required = False)
    ppi = forms.IntegerField(label='PPI',min_value=0, max_value=1000, required = False)
    cpu = forms.CharField(label='CPU', max_length=128, required = False)
    chipset = forms.CharField(label='Chipset', max_length=23, required = False)
    gpu = forms.CharField(label='GPU', max_length=64, required = False)
    ...
    battery_capacity = forms.IntegerField(label='Battery', min_value=0, step_size = 100, required = False)
