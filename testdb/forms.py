...
class AdminPhoneForm(forms.Form):
    ...
    resolution = forms.CharField(label='Resolution', max_length=12, required = False)
    ppi = forms.IntegerField(label='PPI',min_value=0, max_value=1000, required = False)
    cpu_name = forms.CharField(label='CPU', max_length=128, required = True)
    chipset_name = forms.CharField(label='Chipset', max_length=23, required = True)
    gpu_name = forms.CharField(label='GPU', max_length=64, required = True)
